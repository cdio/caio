...
std::map<sf::Keyboard::Key, Keyboard::Key> UISfml::sfml_to_key{
    ...
    { sf::Keyboard::Key::Numpad0,   Keyboard::KEY_NUMPAD_0          },
    { sf::Keyboard::Key::Numpad1,   Keyboard::KEY_NUMPAD_1          },
    { sf::Keyboard::Key::Numpad2,   Keyboard::KEY_NUMPAD_2          },
    { sf::Keyboard::Key::Numpad3,   Keyboard::KEY_NUMPAD_3          },
    { sf::Keyboard::Key::Numpad4,   Keyboard::KEY_NUMPAD_4          },
    { sf::Keyboard::Key::Numpad5,   Keyboard::KEY_NUMPAD_5          },
    { sf::Keyboard::Key::Numpad6,   Keyboard::KEY_NUMPAD_6          },
    { sf::Keyboard::Key::Numpad7,   Keyboard::KEY_NUMPAD_7          },
    { sf::Keyboard::Key::Numpad8,   Keyboard::KEY_NUMPAD_8          },
    { sf::Keyboard::Key::Numpad9,   Keyboard::KEY_NUMPAD_9          },
    { sf::Keyboard::Key::Add,       Keyboard::KEY_NUMPAD_PLUS       },
    { sf::Keyboard::Key::Subtract,  Keyboard::KEY_NUMPAD_MINUS      },
    { sf::Keyboard::Key::Multiply,  Keyboard::KEY_NUMPAD_ASTERISK   },
    { sf::Keyboard::Key::Divide,    Keyboard::KEY_NUMPAD_SLASH      }
