...
//XXX #include "prgfile.hpp"
#include "utils.hpp"


namespace caio {

const std::vector<ZilogZ80Monitor::Command> ZilogZ80Monitor::commands{
    { "assemble", "a",  ".|$addr",            "Assemble machine code from $addr",       ZilogZ80Monitor::assemble    },
    { "disass",   "d",  ".|$addr [$n]",       "Disassemble $n instructions from $addr", ZilogZ80Monitor::disassemble },
    { "dump",     "x",  ". [$n]",             "Dump $n bytes of memory from $addr",     ZilogZ80Monitor::dump        },
    { "regs",     "r",  "",                   "Show registers",                         ZilogZ80Monitor::registers   },
    { "mmap",     "m",  "",                   "Show memory map",                        ZilogZ80Monitor::mmap        },
    { "bpadd",    "b",  "$addr",              "Add a breakpoint at $addr",              ZilogZ80Monitor::bp_add      },
    { "bpadd",    "b",  "$addr <cond>",       "Add a conditional breakpoint at $addr",  ZilogZ80Monitor::bp_add      },
    { "bpadd",    "b",  "help|h|?",           "Help about breakpoints",                 ZilogZ80Monitor::bp_add      },
    { "bpdel",    "bd", "$addr",              "Delete breakpoint at $addr",             ZilogZ80Monitor::bp_del      },
    { "bpclear",  "bc", "",                   "Clear all breakpoints",                  ZilogZ80Monitor::bp_clear    },
    { "bplist",   "bl", "",                   "List breakpoints",                       ZilogZ80Monitor::bp_list     },
    { "go",       "g",  ".|$addr",            "Run program at $addr",                   ZilogZ80Monitor::go          },
    { "si",       "s",  "[.|$addr]",          "Execute single instruction",             ZilogZ80Monitor::step        },
    { "load",     "l",  "<prog> [$addr]",     "Load a binary or PRG file",              ZilogZ80Monitor::load        },
    { "save",     "w",  "<prog> $start $end", "Save a PRG file",                        ZilogZ80Monitor::save        },
    { "loglevel", "lv", "<lv>",               "Set the CPU loglevel",                   ZilogZ80Monitor::loglevel    },
    { "quit",     "q",  "",                   "Halt the CPU",                           ZilogZ80Monitor::quit        },
    { "quit",     "q",  "<e>",                "Terminate the emulator with exit code",  ZilogZ80Monitor::quit        },
    { "help",     "h",  "",                   "This help",                              ZilogZ80Monitor::help        },
    { "help",     "?",  "",                   "",                                       ZilogZ80Monitor::help        }
};


const std::vector<std::pair<std::string, ZilogZ80Monitor::Expr::ex_t>> ZilogZ80Monitor::Expr::operators{
    { "<=", [](const Mos6502 &cpu, const ZilogZ80Monitor::Expr::fn_t &a, const ZilogZ80Monitor::Expr::fn_t &b) {
        return a(cpu) <= b(cpu);
    }},
    { ">=", [](const Mos6502 &cpu, const ZilogZ80Monitor::Expr::fn_t &a, const ZilogZ80Monitor::Expr::fn_t &b) {
        return a(cpu) >= b(cpu);
...
const std::vector<std::pair<std::string, ZilogZ80Monitor::Expr::fn_t>> ZilogZ80Monitor::Expr::registers{
...
ZilogZ80Monitor::Expr::fn_t ZilogZ80Monitor::Expr::compile_argument(const std::string &line)
{
    /*
...
std::pair<ZilogZ80Monitor::Expr::fn_t, std::exception> ZilogZ80Monitor::Expr::compile(const std::string &line)
{
    /*
     * <expr> = <val1> <op> <val2>
     */
...
bool ZilogZ80Monitor::is_breakpoint(addr_t addr) const
{
...
std::string ZilogZ80Monitor::prompt()
{
    std::ostringstream os{};

    if (_prev_fn == ZilogZ80Monitor::step) {
...
addr_t ZilogZ80Monitor::to_addr(const std::string &str, addr_t defval)
{
    return ((str == ".") ? defval : static_cast<addr_t>(to_count(str)));
}

size_t ZilogZ80Monitor::to_count(const std::string &str)
{
    try {
...
bool ZilogZ80Monitor::assemble(ZilogZ80Monitor &self, const std::vector<std::string> &args)
{
    /*
     * assemble [<addr>|.]
     * a [<addr>|.]
...
bool ZilogZ80Monitor::disassemble(ZilogZ80Monitor &self, const std::vector<std::string> &args)
{
    /*
     * disass [<addr> [<count>]]
     * d [<addr> [<count>]]
...
bool ZilogZ80Monitor::dump(ZilogZ80Monitor &self, const std::vector<std::string> &args)
{
    /*
     * dump [<addr> [<count>]]
     * x [<addr> [<count>]]
...
bool ZilogZ80Monitor::registers(ZilogZ80Monitor &self, const std::vector<std::string> &args)
{
    /*
     * registers, r
     */
...
bool ZilogZ80Monitor::mmap(ZilogZ80Monitor &self, const std::vector<std::string> &args)
{
    /*
     * mmap, m
     */
...
bool ZilogZ80Monitor::bp_add(ZilogZ80Monitor &self, const std::vector<std::string> &args)
{
    /*
...
bool ZilogZ80Monitor::bp_del(ZilogZ80Monitor &self, const std::vector<std::string> &args)
{
    /*
     * bpdel <addr>
     * bd <addr>
...
bool ZilogZ80Monitor::bp_clear(ZilogZ80Monitor &self, const std::vector<std::string> &args)
{
    /*
     * bpclear, bc
     */
...
bool ZilogZ80Monitor::bp_list(ZilogZ80Monitor &self, const std::vector<std::string> &args)
{
    /*
     * bplist, bl
     */
...
bool ZilogZ80Monitor::go(ZilogZ80Monitor &self, const std::vector<std::string> &args)
{
    /*
     * go [<addr>|.]
     * g [<addr>|.]
...
bool ZilogZ80Monitor::step(ZilogZ80Monitor &self, const std::vector<std::string> &args)
{
    /*
     * step [<addr>|.]
     * s [<addr>|.]
...
bool ZilogZ80Monitor::load(ZilogZ80Monitor &self, const std::vector<std::string> &args)
{
    /*
     * load <filename> [$addr]
     */
...
bool ZilogZ80Monitor::save(ZilogZ80Monitor &self, const std::vector<std::string> &args)
{
    /*
...
bool ZilogZ80Monitor::loglevel(ZilogZ80Monitor &self, const std::vector<std::string> &args)
{
    /*
     * loglevel <lv>
     * l <lv>
...
bool ZilogZ80Monitor::quit(ZilogZ80Monitor &self, const std::vector<std::string> &args)
{
    /*
     * quit, q
     */
...
bool ZilogZ80Monitor::help(ZilogZ80Monitor &self, const std::vector<std::string> &args)
{
    /*
     * help, h, ?
     */
