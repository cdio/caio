...
/**
 * The monitor is used to debug an emulated a Zilog Z80 cpu when it is running.
 * The user communicates with the monitor through specified input/output streams.
 */
class ZilogZ80Monitor {
public:
    /**
    ...
    class Expr {
    public:
        using fn_t = std::function<int(const class ZilogZ80 &)>;
        using ex_t = std::function<int(const class ZilogZ80 &, const fn_t &, const fn_t &)>;
    ...
    /**
     * Initialise this MOS6502 monitor.
     ...
     */
    ZilogZ80Monitor(std::istream &is, std::ostream &os, class ZilogZ80 &cpu)
        : _is{is},
          _os{os},
          _cpu{cpu} {
    }

    virtual ~ZilogZ80Monitor() {
    }

    /**
     * Start this MOS6502 monitor.
...
private:
    ...
    using fn_t = bool (*)(ZilogZ80Monitor &, const std::vector<std::string> &args);
    ...
    static bool assemble    (ZilogZ80Monitor &self, const std::vector<std::string> &args);
    static bool disassemble (ZilogZ80Monitor &self, const std::vector<std::string> &args);
    static bool dump        (ZilogZ80Monitor &self, const std::vector<std::string> &args);
    static bool registers   (ZilogZ80Monitor &self, const std::vector<std::string> &args);
    static bool mmap        (ZilogZ80Monitor &self, const std::vector<std::string> &args);

    static bool bp_add      (ZilogZ80Monitor &self, const std::vector<std::string> &args);
    static bool bp_del      (ZilogZ80Monitor &self, const std::vector<std::string> &args);
    static bool bp_clear    (ZilogZ80Monitor &self, const std::vector<std::string> &args);
    static bool bp_list     (ZilogZ80Monitor &self, const std::vector<std::string> &args);

    static bool go          (ZilogZ80Monitor &self, const std::vector<std::string> &args);
    static bool step        (ZilogZ80Monitor &self, const std::vector<std::string> &args);

    static bool load        (ZilogZ80Monitor &self, const std::vector<std::string> &args);
    static bool save        (ZilogZ80Monitor &self, const std::vector<std::string> &args);

    static bool loglevel    (ZilogZ80Monitor &self, const std::vector<std::string> &args);

    static bool quit        (ZilogZ80Monitor &self, const std::vector<std::string> &args);
    static bool help        (ZilogZ80Monitor &self, const std::vector<std::string> &args);
